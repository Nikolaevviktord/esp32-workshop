...
<details open>
  ...
  Краткое объяснение принципов работы основных протоколов связи размещено в отдельном [файле](github.com/Nikolaevviktord/esp32-workshop/blob/master/task-0-1/communication.md). Ниже приведены таблицы с характеристиками плат относительно поддержки протоколов связи.
